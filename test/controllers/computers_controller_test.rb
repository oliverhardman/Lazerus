...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { case: @computer.case, cpu: @computer.cpu, description: @computer.description, finish: @computer.finish, grpahics_card: @computer.grpahics_card, hardrive: @computer.hardrive, motherboard: @computer.motherboard, power_supply: @computer.power_supply, price: @computer.price, ram: @computer.ram, title: @computer.title } }
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { case: @computer.case, cpu: @computer.cpu, description: @computer.description, finish: @computer.finish, grpahics_card: @computer.grpahics_card, hardrive: @computer.hardrive, motherboard: @computer.motherboard, power_supply: @computer.power_supply, price: @computer.price, ram: @computer.ram, title: @computer.title } }
